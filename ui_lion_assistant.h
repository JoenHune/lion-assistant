...
public:
    ...
    void setupUi(QMainWindow *lion_assistant)
    {
        ...
        btn_dataLine->setGeometry(QRect(140, 149, 61, 23));
        ...
        vSlider_offset->setGeometry(QRect(280, 9, 22, 161));
        ...
        btn_zeroOffset->setGeometry(QRect(70, 149, 61, 23));
        ...
        btn_referLine->setGeometry(QRect(210, 149, 61, 23));
        btn_ch4->raise();
        ...
        btn_Mark->setGeometry(QRect(0, 90, 141, 23));
        ...
        btn_SendPID->setGeometry(QRect(160, 90, 141, 23));
        ...
        widget_6->setMinimumSize(QSize(141, 201));
        widget_6->setMaximumSize(QSize(141, 201));
        btn_Clear = new QPushButton(widget_6);
        btn_Clear->setObjectName(QStringLiteral("btn_Clear"));
        btn_Clear->setGeometry(QRect(0, 179, 141, 23));
        groupBox_2 = new QGroupBox(widget_6);
        groupBox_2->setObjectName(QStringLiteral("groupBox_2"));
        groupBox_2->setGeometry(QRect(0, 0, 141, 171));
        ...
        cb_AutoNewLine->setGeometry(QRect(10, 50, 71, 21));
        checkBox_2 = new QCheckBox(groupBox_2);
        checkBox_2->setObjectName(QStringLiteral("checkBox_2"));
        checkBox_2->setGeometry(QRect(10, 80, 71, 21));
        ...
        cb_DoubleColor->setGeometry(QRect(10, 140, 101, 21));
    ...
    void retranslateUi(QMainWindow *lion_assistant)
    {
        ...
        btn_Mark->setText(QApplication::translate("lion_assistant", "\350\256\260\345\275\225", nullptr));
        ...
        checkBox_2->setText(QApplication::translate("lion_assistant", "\346\230\276\347\244\272\345\217\221\351\200\201", nullptr));
